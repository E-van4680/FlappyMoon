...
window.onload = function() {
	...
	setInterval(placeRocas, 1820);
	setInterval(placeTecho, 1820);
	document.addEventListener("keydown", moveLem);
	document.addEventListener("click", moveLemClick);	
...
setTimeout(() => {
        lemImg.src = "./LEM.png";
        lem.height = 71;
    }, 70); // Cambia el valor 100 según tus necesidades
}	
